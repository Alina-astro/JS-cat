...
const makeOne = () => {
	...
	//Ваш код
	const sum = num1 + num2;
	return resultOne.innerHTML = sum;
};
...
const makeTwo = () => {
	...
	//Ваш код
	const dif = num1 - num2;
	return resultTwo.innerHTML = dif;
};
...
const makeThree = () => {
	...
	return resultThree.innerHTML = multiplication;
};
...
const makeFour = () => {
	...
	return resultFour.innerHTML = dividing;
};
...
const makeFive = () => {
	...
	const power = 4;
	//Ваш код
	return resultFive.innerHTML = Math.pow(num, power);
};
...
const makeSix = () => {
	...
	//Ваш код
	const dividing = num1 / num2;
	return resultSix.innerHTML = dividing;
};
...
const makeSeven = () => {
	...
	return resultSeven.innerHTML = remainder;
};
...
const makeNine = () => {
	...
	return resultNine.innerHTML = remainder;
};
...
const makeTen = () => {
	const str = 'Hello';
	//Ваш код
	return resultTen.innerHTML = str[2];
};
...
const makeEleven = () => {
	//Ваш код
	const remainder = 5 % 2;
	return resultEleven.innerHTML = remainder;
};
...
const makeTwelve = () => {
	...
	const str2 = 'World!';
	//Ваш код
	return resultTwelve.innerHTML = str1 + str2;
};
...
const makeThirteen = () => {
	...
	//Ваш код
	return resultThirteen.innerHTML = str.length;
};
...
const makeFourteen = () => {
	const str = 'JavaScript';
	//Ваш код
	return resultFourteen.innerHTML = str.toLowerCase();
};
...
const makeFifteen = () => {
	const str = 'JavaScript';
	//Ваш код
	return resultFifteen.innerHTML = str.toUpperCase();
};
...
const makeSixteen = () => {
	const str = 'JavaScript';
	//Ваш код
	return resultSixteen.innerHTML = str.substring(3);
};
...
const makeSeventeen = () => {
	const str = 'JavaScript';
	//Ваш код
	return resultSeventeen.innerHTML = str.substring(3, 7);
};
...
const makeEighteen = () => {
	...
	//Ваш код
	return resultEighteen.innerHTML = str.replace('world', 'JavaScript');
};
...
const makeNineteen = () => {
	const str = 'Hello, world!';
	//Ваш код
	return resultNineteen.innerHTML = str.substring(7, 13);
};
...
const makeTwenty = () => {
	//Ваш код
	return resultTwenty.innerHTML = Math.max(10, 25, 5, 30, 15);
};
...
const makeTwentyOne = () => {
	//Ваш код
	return resultTwentyOne.innerHTML = Math.floor(Math.random()*10);
};
...
const makeTwentyTwo = () => {
	//Ваш код
	return resultTwentyTwo.innerHTML = Math.min(10, 25, 5, 30, 15);
};
...
const makeTwentyThree = () => {
	//Ваш код
	return resultTwentyThree.innerHTML = Math.pow(2, 5);
};
...
const makeTwentyFour = () => {
	//Ваш код
	return resultTwentyFour.innerHTML = Math.min(7, 3, 11, 5, 9);
};
...
const makeTwentyFive = () => {
	//Ваш код
	return resultTwentyFive.innerHTML = Math.max(7, 3, 11, 5, 9);
};
...
const makeTwentySix = () => {
	//Ваш код
	const num26 = Math.random();
	return resultTwentySix.innerHTML = num26.toFixed(4);
};
